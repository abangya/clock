...
import com.deyi.clock.generator.CustomizeJavaMapperGenerator;
import com.deyi.clock.service.CodeGenerator;
import com.deyi.clock.service.CodeGeneratorManager;
import com.deyi.clock.util.StringUtils;
...
public class ModelAndMapperGenerator extends CodeGeneratorManager implements CodeGenerator {
    ...
    private Context initConfig(String tableName, String modelName) {
        ...
        try {
            context = initMybatisGeneratorContext(MAPPER_XML_PACKAGE);
