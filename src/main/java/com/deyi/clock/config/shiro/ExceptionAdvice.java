...
import com.deyi.clock.config.shiro.exception.CustomException;
import com.deyi.clock.config.shiro.exception.CustomUnauthorizedException;
...
public class ExceptionAdvice {
    ...
    public ResponseBean globalException(HttpServletRequest request, Throwable ex) {
        exceptionLogger.error(ex.toString());
