...
var DateUtils = {
	 ...
	 * @returns {string}
	 */
	formatterDateToString:function(v){
		var date = new Date(v);
	...
	seconds:function (value) {
		...
		var dataStr = this.dateFormat("yyyy-MM-dd",date);
		var date2=new Date(dataStr+" 09:00:00");
		var seconds=(date.getTime()-date2.getTime())/1000;   //相差秒数
		return seconds;
	}
};
